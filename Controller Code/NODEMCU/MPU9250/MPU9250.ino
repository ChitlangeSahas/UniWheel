...
ESP8266VESC esp8266VESC = ESP8266VESC(escSoftwareSerial);   // ESP8266VESC instance 
...
void loop()
{
  ...
  esp8266VESC.setDutyCycle(Output/100.0); // set the ESC output to the Calculated output from PID
